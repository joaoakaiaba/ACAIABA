  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 space-y-8">
      ...
      <div className="border-b border-gray-100 dark:border-slate-800 pb-5">
        <h1 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight uppercase">Minha Conta</h1>
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Gerencie seu perfil, endereços de entrega e pedidos.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">

        {/* Account menu navigation */}
        <div className="space-y-2 bg-slate-50 dark:bg-slate-900 p-6 rounded-xl border border-gray-100 dark:border-slate-800 h-fit">
          <div className="flex items-center space-x-3 border-b border-gray-200 dark:border-slate-700 pb-4 mb-4">
          ...
          <Link href="/pedidos" className="flex items-center space-x-3 px-4 py-2.5 rounded-lg text-xs font-bold text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:bg-slate-800 dark:hover:bg-slate-700 uppercase tracking-wider transition-colors">
            <ShoppingBag className="h-4 w-4 text-gray-400" />
            <span>Meus Pedidos</span>
          </Link>
          {isAdmin && (
            <Link href="/admin" className="flex items-center space-x-3 px-4 py-2.5 rounded-lg text-xs font-bold text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:bg-slate-800 dark:hover:bg-slate-700 uppercase tracking-wider transition-colors">
        ...
        <div className="md:col-span-3 space-y-6">
          <div className="rounded-xl border border-gray-100 dark:border-slate-800 p-6 space-y-4">
            <h3 className="font-extrabold text-slate-900 dark:text-white uppercase tracking-tight border-b border-gray-100 dark:border-slate-800 pb-3">Informações Pessoais</h3>
          ...
          <div className="rounded-xl border border-gray-100 dark:border-slate-800 p-6 space-y-4">
            <h3 className="font-extrabold text-slate-900 dark:text-white uppercase tracking-tight border-b border-gray-100 dark:border-slate-800 pb-3">Segurança</h3>
