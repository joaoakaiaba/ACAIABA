  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="space-y-8 bg-slate-50 p-8 rounded-xl border border-gray-100">
          <h2 className="text-xl font-bold text-slate-900 uppercase tracking-tight border-b border-gray-200 pb-3">
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h4 className="font-bold text-slate-900 text-sm uppercase">Atendimento WhatsApp</h4>
                <p className="text-xs text-gray-500 mt-0.5">Segunda a Sexta, das 9h às 18h</p>
                <a
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h4 className="font-bold text-slate-900 text-sm uppercase">E-mail de Suporte</h4>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h4 className="font-bold text-slate-900 text-sm uppercase">Sede Administrativa</h4>
        ...
        {/* Contact Form */}
        <div className="space-y-6">
          <h2 className="text-xl font-bold text-slate-900 uppercase tracking-tight border-b border-gray-100 pb-3">
            Envie uma Mensagem
          </h2>
          ...
          {status === "success" ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="text-xs font-black text-gray-900 uppercase tracking-wider block mb-2">E-mail de Contato</label>
                <input
                  type="email"
                  required
                  value={email}
              ...
              <div>
                <label className="text-xs font-black text-gray-900 uppercase tracking-wider block mb-2">Mensagem</label>
                <textarea
                  required
                  rows={4}
                  value={message}
                  ...
                  className="w-full rounded-lg border border-gray-200 bg-gray-50 py-2.5 px-4 text-sm outline-none focus:border-amber-500 focus:bg-white resize-none"
                />
              </div>
